...
class _ProjectDetailDialogState extends State<ProjectDetailDialog> {
  ...
  Widget build(BuildContext context) {
      ...
      return Padding(
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              Text(
                AppLocalizations.of(context).getString('aboutProject'),
    ...
    return Dialog(
      ...
      child: Container(
        width: isDesktop ? 1000 : width * 0.95,
              ...
              child: isDesktop
                  ? Row(
                      children: [
                        ...
                        Expanded(flex: 7, child: _buildCarousel(images)),
                        Container(width: 1, color: Colors.white10),
                        // Right: Description & Tags
                        Expanded(flex: 3, child: buildDescription()),
                      ],
                    )
                  : Column(
                      children: [
                        // Top: Image Carousel (Fixed height on Mobile)
                        SizedBox(height: 250, child: _buildCarousel(images)),
                        const Divider(color: Colors.white10, height: 1),
